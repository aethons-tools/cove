#!/usr/bin/env bash
# build.sh — build at-cove, at-dispatch, and at-task, host-sensitive by default.
#
...
#
#   dist/<os>-<arch>/<binary>   # e.g. dist/linux-amd64/{at-cove,at-dispatch,at-task}
#
...
BINARIES=(at-cove at-dispatch at-task)
