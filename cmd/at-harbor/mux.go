...
// messagesMux routes exactly "/messages", "/messages/targets", and
// "/messages/commit" to msgH and "/escalate" to escH; every other path goes
// to broker unchanged. Used to mount harbor's brokered ticket-messaging
